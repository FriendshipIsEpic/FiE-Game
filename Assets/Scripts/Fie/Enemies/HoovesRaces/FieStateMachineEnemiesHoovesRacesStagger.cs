...
{
	public class FieStateMachineEnemiesHoovesRacesStagger : FieStateMachineGameCharacterBase
	{
		...
		public override void updateState<T>(ref T gameCharacter)
		{
			if (gameCharacter is FieEnemiesHoovesRaces)
			{
				...
				{
					int animationId = 3;
					if (fieEnemiesHoovesRaces.groundState == FieObjectGroundState.Flying)
					{
						_nextState = typeof(FieStateMachineEnemiesHoovesRacesStaggerFall);
					...
					TrackEntry trackEntry = fieEnemiesHoovesRaces.animationManager.SetAnimation(animationId, isLoop: false, isForceSet: true);
		...
		public override List<Type> getAllowedStateList()
		{
			...
			list.Add(typeof(FieStateMachineEnemiesHoovesRacesStagger));
			return list;
		}
	}
}
