...
{
	[FiePrefabInfo("Prefabs/Enemies/ChangelingForces/QueenChrysalis/Power/QueenChrysalisDoubleSlashSecond")]
	public class FieEmitObjectQueenChrysalisDoubleSlashSecond : FieEmittableObjectBase
	{
		[SerializeField]
