...
{
	[FiePrefabInfo("Prefabs/Enemies/ChangelingForces/QueenChrysalis/Power/QueenChrysalisShootingConcentration")]
	public class FieEmitObjectQueenChrysalisShootingConcentration : FieEmittableObjectBase
	{
		private const float MAXIMUM_EMITTING_DURATION = 3f;

		private const float MAXIMUM_DURATION = 4f;
