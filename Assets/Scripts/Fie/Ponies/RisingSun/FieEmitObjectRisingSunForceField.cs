...
{
	[FiePrefabInfo("Prefabs/RisingSun/Power/RisingSunForceField")]
	public class FieEmitObjectRisingSunForceField : FieEmittableObjectBase
	{
		[SerializeField]
		...
		private void emitForceFieldEntity()
		{
			...
			FieManagerBehaviour<FieEmittableObjectManager>.I.EmitObject<FieEmitObjectRisingSunForceFieldEmitEffect>(base.transform, Vector3.zero, targetTransform, base.ownerCharacter);
