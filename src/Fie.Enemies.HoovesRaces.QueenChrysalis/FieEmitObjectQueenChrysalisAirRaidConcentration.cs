...
{
	[FiePrefabInfo("Prefabs/Enemies/ChangelingForces/QueenChrysalis/Power/QueenChrysalisAirRaidConcentration")]
	public class FieEmitObjectQueenChrysalisAirRaidConcentration : FieEmittableObjectBase
	{
		private const float MAXIMUM_EMITTING_DURATION = 4f;

		private const float MAXIMUM_DURATION = 5f;
